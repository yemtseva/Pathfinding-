...
namespace PathFindingVisualizer.Pages
{
    ...
    public class Node
    {
        ...
        public static int col_num { get; set; } = 35;
        public static int row_num { get; set; } = 15;
        public static int start_row { get; set; } = 13;
        public static int start_col { get; set; } = 10;
        public static int finish_row { get; set; } = 7;
        public static int finish_col { get; set; } = 32;
